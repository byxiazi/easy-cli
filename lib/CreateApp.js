...
var CreateApp = /** @class */ (function () {
    function CreateApp(name, targetDir) {
        ...
        this.init = function (isTS) {
            var srcPath = path_1.default.join(_this.targetDir, 'src');
            var scriptsPath = path_1.default.join(_this.targetDir, 'scripts');
            _this.generator.mkdirs(srcPath);
            _this.generator.mkdirs(scriptsPath);
            ...
            _this.generator.copyFiles({
                verifyCommitMsg: path_1.default.resolve(__dirname, '..', 'templates/verify-commit-msg.js'),
            }, {
                verifyCommitMsg: path_1.default.join(scriptsPath, 'verify-commit-msg.js'),
            });
            if (isTS) {
                _this.addTSTemplate();
            }
    ...
    CreateApp.prototype.afterCreated = function () {
